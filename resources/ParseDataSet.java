...
public class ParseDataSet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String everything;
        try(BufferedReader br = new BufferedReader(new FileReader("/Users/swati.arora/Documents/Coding/Java programs/intelli_workspace/src/FakeNews/trainingSet.dat"))) {
        ...
        try(BufferedReader br = new BufferedReader(new FileReader("/Users/swati.arora/Documents/Coding/Java programs/intelli_workspace/src/FakeNews/trainingSetLabels.dat"))) {
            int count = 0;
        ...
        while(strings.hasMoreTokens()){
            ...
            try(BufferedWriter br = new BufferedWriter(new FileWriter("/Users/swati.arora/Documents/Coding/Java programs/intelli_workspace/src/FakeNews/"+directory+"/"+fileName+".txt"))) {
